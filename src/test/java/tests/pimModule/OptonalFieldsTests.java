...
public class OptonalFieldsTests extends BaseTest {
    ...
    public void TC206_desactivarSINField() {
        ...
        optionalFieldsPage.turnOffSINSwitch();
        optionalFieldsPage.clickSaveButton();
        ...
        boolean taxExemptionsDisplayed = employeeDetailPage.checkSINGroupIsHidden();
        assertTrue(taxExemptionsDisplayed, "No se muestra correctamente el menu de 'SIN number'");
    }
    ...
    public void TC207_activarUSTaxExemptions() {
        ...
        boolean taxExemptionsDisplayed = employeeDetailPage.checkTaxExemptionsMenuIsVisible();
    ...
    public void TC208_desactivarUSTaxExemptions() {
        ...
        boolean taxExemptionsDisplayed = employeeDetailPage.checkTaxExemptionsMenuIsHidden();
